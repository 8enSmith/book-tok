// Book subject categories with their corresponding work counts
export const BOOK_SUBJECTS = [
  { value: 'biography', label: 'Biography', numberOfWorks: 831480 },
  { value: 'fantasy', label: 'Fantasy', numberOfWorks: 12761 },
  ...
  { value: 'thriller', label: 'Thriller', numberOfWorks: 2293 },
]
